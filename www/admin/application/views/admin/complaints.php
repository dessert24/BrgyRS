    ...
    <?php require 'header.php'; require 'aside.php'; ?>      
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <?php 
            if(count($admin->admin_model->getcomplaints()) == 0)
            {
              ...
              ?>
                <ul>
                  <table width="100%">
                    ...
                    <?php foreach($admin->admin_model->getcomplaints() as $row) { ?>
                    <tr><td><br></td></tr>
                    <tr>
                      ...
                      <td align="center">
                        <a href="<?php echo base_url('index.php/admin/deleteComplaints/'.$row->id.''); ?>"><i class="fa fa-trash" style="margin-right:5px;"></i></a>
                      </td>
                    </tr>
                  <?php } ?>
                  </table>
