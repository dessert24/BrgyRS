    ...
    <?php require 'header.php'; require 'aside.php'; ?>      
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <i class="fa fa-users" style="margin-right:5px;"></i>Customer Users
            <small>Listing</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Customer Users</li>
          </ol>
        </section><br>
          ...
          <div class="row">
            <div class="col-md-12">
              <br><br>
               ...
               <h3><b> Customer Users</b></h3>
          <?php 
            if(count($admin->admin_model->getUsers()) == 0)
            {
              ...
              ?>
                <ul>
                  <table width="100%">
                    ...
                    <?php foreach($admin->admin_model->getUsers() as $row) { ?>
                    <tr><td><br></td></tr>
                    <tr>
